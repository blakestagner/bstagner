...
export default function Calendar({ events = [], onAddEvent, onDeleteEvent, fullFeatures = false }) {
    ...
    const rightWhite = '/icons/components/rightWhite.svg';
    const leftWhite = '/icons/components/leftWhite.svg';
