...
export default function HeroText({ loading }) {
    ...
    const heroScroll = () => {
        ...
        headingOne.style.transform = `translate3d(-${heroAnimationPercent * 2.5}%, 0px, 0px)`;
        headingTwo.style.transition = 'all linear 0ms';
        headingTwo.style.transitionDelay = '0ms';
        headingTwo.style.transform = `translate3d(-${heroAnimationPercent * 3}%, 0px, 0px)`;
        headingThree.style.transition = 'all linear 0ms';
        headingThree.style.transitionDelay = '0ms';
        headingThree.style.transform = `translate3d(-${heroAnimationPercent * 3}%, 0px, 0px)`;
    }
