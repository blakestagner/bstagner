...
import topIcon from '../Components/img/arrow_upward.svg';
            ...
            <div className='footer-1'>
                <div>
                    ...
                    <a rel='noopener' href='https://www.linkedin.com/in/blakestagner/' target='_blank' aria-label='Linkedin Link'>
                        <img className='social-icon' src={inIcon} alt='linkedin' />
                    </a>
                    <a href='https://www.github.com/blakestagner' target='_blank' rel='noopener' aria-label='fbook in Link'>
                        <svg viewBox='0 0 128 128' className='social-icon'>
                            <g fill='#fff'>
                                <path
                                    fillRule='evenodd'
                                    clipRule='evenodd'
                    ...
                    <ButtonFooter click={scrollTop} name='scroll to top' icon={topIcon} />
                </div>
            </div>
